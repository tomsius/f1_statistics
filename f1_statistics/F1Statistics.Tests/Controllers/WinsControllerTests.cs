...
namespace F1Statistics.Tests.Controllers
{
    ...
    public class WinsControllerTests
    {
        ...
        public void GetDriversAverageWins_ReturnAggregatedWinnersListWithAverageWins_IfThereAreAnyDrivers()
        {
            ...
            _service.Setup((service) => service.AggregateDriversWinAverage(It.IsAny<OptionsModel>())).Returns(expectedWinnersWithAverageWins);

            // Act
            var actual = _controller.GetDriversWinAverage(options);
        ...
        public void GetDriversAverageWins_ReturnEmptyList_IfThereAreNoDrivers()
        {
            ...
            _service.Setup((service) => service.AggregateDriversWinAverage(It.IsAny<OptionsModel>())).Returns(expectedWinners);
        ...
        public void GetConstructorsAverageWins_ReturnAggregatedWinnersListWithAverageWins_IfThereAreAnyConstructors()
        {
            ...
            var options = new OptionsModel();
            var expectedWinnersWithAverageWins = GenerateWinnersWithAverageWins();
            _service.Setup((service) => service.AggregateConstructorsWinAverage(It.IsAny<OptionsModel>())).Returns(expectedWinnersWithAverageWins);

            // Act
            var actual = _controller.GetConstructorsWinAverage(options);
        ...
        public void GetConstructorsAverageWins_ReturnEmptyList_IfThereAreNoConstructors()
        {
            ...
            var options = new OptionsModel();
            var expectedWinners = new List<AverageWinsModel>();
            _service.Setup((service) => service.AggregateConstructorsWinAverage(It.IsAny<OptionsModel>())).Returns(expectedWinners);
